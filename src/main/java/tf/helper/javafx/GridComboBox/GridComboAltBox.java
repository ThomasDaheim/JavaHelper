 ...
 * @param <T>
 */
public class GridComboAltBox<T> extends Control {
    ...
    private final GridComboBoxAltSkin<T> gridComboBoxSkin = new GridComboBoxAltSkin<>(this);
     ...
     */
    public GridComboAltBox(final ObservableList<T> items) {
        if (items != null) {
