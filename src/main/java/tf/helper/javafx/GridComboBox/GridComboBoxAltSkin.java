 ...
 * @param <T>
 */
public class GridComboBoxAltSkin<T> extends SkinBase<GridComboAltBox<T>> {
    ...
    // data
    private final GridComboAltBox<T> control;
    ...
    public GridComboBoxAltSkin(final GridComboAltBox<T> control) {
        super(control);
